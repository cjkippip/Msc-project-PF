...
% UKF estimate 2 parameters, one guess of initial state
%%
clear, clc;
...
grid on
grid minor
%% UKF estimate state and parameter alpha and beta
...
for k=1:2                               
    ...
    if k==1
        title('UKF estimate states','FontSize',15);
    end
    xlabel('Time','FontSize',13,'FontWeight','bold'); 
    ylabel('Number of spicies','FontSize',13,'FontWeight','bold'); 
...
for k=1:2                              
    ...
    if k==1
        title('UKF estimate parameter','FontSize',15);
    end
    xlabel('Time','FontSize',13,'FontWeight','bold'); 
