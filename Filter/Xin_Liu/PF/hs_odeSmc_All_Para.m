...
%                three state variables and six parameters. 
%
%   Input:
%                 t:        The time step of the simulation.
%                 y:        Values of underlying states.
%                 para:     The underlying parameter vector.
%   
%   Output:
%                 hsState:  The updated values of states are obtained from
%                           integrating input states respect to sampling
%                           interval.
%
%   Date: 25/04/2011
%
