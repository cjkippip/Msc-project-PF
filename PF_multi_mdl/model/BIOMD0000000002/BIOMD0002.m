...
% Reaction: id = React0, name = React0
	reaction_React0=compartment_comp1*(global_par_kf_0*x(6)*x(13)-global_par_kr_0*x(5));

% Reaction: id = React1, name = React1
	reaction_React1=compartment_comp1*(global_par_kf_1*x(5)*x(13)-global_par_kr_1*x(1));
...
% Reaction: id = React3, name = React3
	reaction_React3=compartment_comp1*(global_par_kf_3*x(4)*x(13)-global_par_kr_3*x(3));

% Reaction: id = React4, name = React4
	reaction_React4=compartment_comp1*(global_par_kf_4*x(3)*x(13)-global_par_kr_4*x(12));
...
% Reaction: id = React7, name = React7
	reaction_React7=compartment_comp1*(global_par_kf_7*x(11)*x(13)-global_par_kr_7*x(2));

% Reaction: id = React8, name = React8
	reaction_React8=compartment_comp1*(global_par_kf_8*x(2)*x(13)-global_par_kr_8*x(9));
...
% Reaction: id = React12, name = React12
	reaction_React12=compartment_comp1*(global_par_kf_12*x(8)*x(13)-global_par_kr_12*x(10));

% Reaction: id = React13, name = React13
	reaction_React13=compartment_comp1*(global_par_kf_13*x(10)*x(13)-global_par_kr_13*x(7));
